    <!-- WIDGETS -->
<script type="text/javascript" src="<?php echo base_url(); ?>assets/tether/js/tether.js"></script>
...
<script type="text/javascript" src="<?php base_url(); ?>assets/widgets/superclick/superclick.js"></script>

<!-- Input switch alternate -->

<script type="text/javascript" src="<?php base_url(); ?>assets/widgets/input-switch/inputswitch-alt.js"></script>
